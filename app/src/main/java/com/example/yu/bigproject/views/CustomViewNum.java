package com.example.yu.bigproject.views;
...
public class CustomViewNum extends LinearLayout {
    ...
    private com.example.yu.bigproject.list.view.CustomViewNum.CallBackListener callBackListener;

    public void setOnCallBack(com.example.yu.bigproject.list.view.CustomViewNum.CallBackListener listener){
